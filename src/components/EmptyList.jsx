...
function EmptyList() {
  return (
    <div className="p-6 my-6 bg-lLight dark:bg-lBlack rounded-md flex flex-col gap-6 justify-between">
      ...
      <button className="p-4 w-64 scale-75 rounded-lg gap-1 bg-black hover:bg-white hover:text-black hover:scale-90 transition-all delay-75 dark:hover:text-white dark:hover:bg-black   dark:bg-slate-200 text-white dark:text-black  text-lg flex justify-center">
